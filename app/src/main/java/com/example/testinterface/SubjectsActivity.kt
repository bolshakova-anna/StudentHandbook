    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.buttonAlgebra).setOnClickListener {
           ...
           // subj.name = "algebra"
            ...
            //intent.putExtra("name","algebra")
            extras.putString("name","Алгебра");
          //  intentLetterChecker.putExtras(extras);
            i.putExtras(extras)
            startActivity(i)
        }
        ...
        findViewById<Button>(R.id.buttonGeometry).setOnClickListener {
           ...
           // subj.name = "geometry"
            ...
            extras.putString("name","Геометрия");
            i.putExtras(extras)
            startActivity(i)
        }
        ...
        findViewById<Button>(R.id.buttonMaths).setOnClickListener {
           ...
           // subj.name = "maths"
            ...
            extras.putString("name","Общая математика");
            i.putExtras(extras)
            startActivity(i)
        }
